...
import { ChevronRight, ArrowUpRight, Box, ShieldAlert, BookOpen, Wrench, AlertTriangle, FileText, Users, Building, AlertCircle, Play, UserX, UserMinus, Gavel, X, Activity, Maximize2, ChevronDown, ArrowRightLeft } from 'lucide-react';
             ...
             <div className="relative z-10 flex flex-col h-full">
               <div className="flex justify-between items-center mb-6">
                 ...
                 <button 
                   ...
                   className="text-primary hover:bg-blue-50 p-1.5 rounded transition-colors flex items-center justify-center gap-1 text-[12px]"
                 >
